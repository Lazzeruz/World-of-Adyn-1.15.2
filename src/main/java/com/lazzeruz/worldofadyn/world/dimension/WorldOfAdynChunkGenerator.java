...
public class WorldOfAdynChunkGenerator extends NoiseChunkGenerator<WorldOfAdynGenSettings> {
    ...
    public WorldOfAdynChunkGenerator(IWorld worldIn, BiomeProvider provider, WorldOfAdynGenSettings settingsIn) {
